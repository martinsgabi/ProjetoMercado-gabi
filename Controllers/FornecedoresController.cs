...
namespace ProjetoMercado.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedoresId,NomeFornecedores,CNPJFornecedores")] Fornecedores fornecedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedoresId,NomeFornecedores,CNPJFornecedores")] Fornecedores fornecedores)
        {
